package com.kalsym.catalogueimportservice.config;
...
public class SwaggerConfig {
    ...
    @Bean
    public Docket CatalogueImportApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.kalsym.catalogueimportservice"))
                .build()
                .apiInfo(apiInfo());
    }
